...
/*   Updated: 2024/05/19 16:16:42 by marvin           ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
 ...
 * @return Pointer to the newly created list element, or NULL if memory allocation fails.
 * Creates a new list element with the specified content.
 * Allocates memory for the new element and initializes its content and next pointer.
