...
/*   Updated: 2024/05/20 11:17:59 by lcorreia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * Clears a linked list and frees the memory of each element using the 
 * provided function.
 *
 ...
 * of an element.
 * 
 * Clears the linked list pointed to by lst and frees the memory of 
 * each element.
 * Uses the provided function del to delete the content of each element.
 * Sets the pointer to the first element of the list (lst) to NULL after 
 * clearing the list.
 */
