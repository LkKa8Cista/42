...
/*   Updated: 2024/05/20 11:17:07 by lcorreia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * If either alst or new is NULL, the function returns without making 
 * any changes.
 * Otherwise, the next pointer of the new element is set to point to the 
 * current first element.
 * Then, the pointer to the first element of the linked list (alst) is updated 
