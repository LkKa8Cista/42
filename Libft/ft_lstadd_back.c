...
/*   Updated: 2024/05/19 16:30:11 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * If the linked list is not empty, traverses the list to find the last element,
 * and then sets the next pointer of the last element to point to the new element.
 * If the linked list is empty, sets the first element of the list to the new element.
 */
