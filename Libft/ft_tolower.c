 ...
 *
 * @param c - The character to be converted to lowercase if it is an uppercase letter.
 * @return The lowercase equivalent of 'c' if 'c' is an uppercase letter, otherwise returns 'c'.
 * This function converts an uppercase letter to its lowercase equivalent if 'c' is an uppercase letter.
